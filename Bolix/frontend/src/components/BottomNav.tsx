import { IconHome, IconChart, IconBell, IconUser, IconWallet } from './icons'

export type Tab = 'home' | 'historial' | 'trades' | 'alertas' | 'perfil'

const TABS: { id: Tab; label: string; icon: React.ReactNode }[] = [
  { id: 'home', label: 'Inicio', icon: <IconHome /> },
  { id: 'historial', label: 'Historial', icon: <IconChart /> },
  { id: 'trades', label: 'Trades', icon: <IconWallet /> },
