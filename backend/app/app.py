        ...
        if cache_entry:
            ...
            if age < 600 and has_new_fields:
                ...
                return {
                    ...
                    "usdt_min": float(cache_entry.data.get('usdt_min', cache_entry.data.get('usdt_binance'))),
                    "usdt_max": float(cache_entry.data.get('usdt_max', cache_entry.data.get('usdt_binance'))),
                    "usdt_avg": float(cache_entry.data.get('usdt_avg', cache_entry.data.get('usdt_binance'))),
