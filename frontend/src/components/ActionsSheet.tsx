    ...
    <div className="flex flex-col gap-4 mt-2">
      ...
      {showDialog && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-sm bg-zinc-900 border border-zinc-800 rounded-[2.5rem] p-6 shadow-2xl animate-in zoom-in-95 duration-200">
            <h3 className="text-lg font-bold text-white mb-1">Datos de Pago</h3>
            <p className="text-zinc-500 text-xs mb-6">Configura tu pago móvil para cobrar por WhatsApp.</p>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1">
          {!isConfigured && (
            <div className="absolute -top-14 right-0 left-0 animate-bounce duration-[3000ms] z-20">
              <div className="bg-yellow-500/95 backdrop-blur-md rounded-xl p-2.5 shadow-xl border border-yellow-400/50">
          ...
          >
            <span className="text-base font-black uppercase tracking-tight">Cobrar</span>
