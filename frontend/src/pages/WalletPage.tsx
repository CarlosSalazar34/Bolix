...
import { fetchWallets, fetchTrades } from '../services/api'
    ...
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between items-center px-1">
          ...
          <button className="text-emerald-500 text-[10px] font-bold uppercase hover:underline">Ver todo</button>
        </div>
            ...
            transactions.map((t, i) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-white text-sm font-semibold leading-tight">{t.descripcion}</p>
